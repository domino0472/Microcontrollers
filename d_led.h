...
#define		LED_DATA_DIR DDRA	// rejestr kierunku portu katod wyœwietlaczy
...
#define 	DA1 	(1<<PD0)		// DA1 oznacza bit nr.0 portu D
#define 	DA2 	(1<<PD1)		// DA2 oznacza bit nr.1 portu D
#define 	DA3 	(1<<PD2)		// DA3 oznacza bit nr.2 portu D
#define 	DA4 	(1<<PD3)		// DA4 oznacza bit nr.3 portu D

#define MASKA_ANODY (DA1|DA2|DA3|DA4)
